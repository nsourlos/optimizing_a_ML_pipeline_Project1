...
In AutoML many different models with different normalization and scaling techniques were used. Models like XGBoostClassifier, RandomForest and LogisticRegression were used, whereas some of the techniques are MAXAbsScaler, SparseNormalizer and StandardScalerNormalizer.
